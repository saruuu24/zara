...
style.configure("TNotebook.Tab", font=("TkDefaultFont", 16, "bold"))
...
def add_note():
    ...
    content_entry = tk.Text(note_frame, width=80, height=20)
...
new_button = ttk.Button(root, text="New Sticky Note",
                        command=add_note, style="info.TButton")
new_button.pack(side=tk.BOTTOM, padx=10, pady=10)
